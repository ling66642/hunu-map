...
`),r={},i=/\s+/,a={};for(let e=0;e<n.length;e++){let t=n[e];if(t=t.trim(),t.length===0||t.charAt(0)===`#`)continue;let o=t.indexOf(` `),s=o>=0?t.substring(0,o):t;s=s.toLowerCase();let c=o>=0?t.substring(o+1):``;if(c=c.trim(),s===`newmtl`)r={name:c},a[c]=r;else if(s===`ka`||s===`kd`||s===`ks`||s===`ke`){let e=c.split(i,3);r[s]=[parseFloat(e[0]),parseFloat(e[1]),parseFloat(e[2])]}else r[s]=c}let o=new gc(this.resourcePath||t,this.materialOptions);return o.setCrossOrigin(this.crossOrigin),o.setManager(this.manager),o.setMaterials(a),o}},gc=class{constructor(e=``,t={}){this.baseUrl=e,this.options=t,this.materialsInfo={},this.materials={},this.materialsArray=[],this.nameLookup={},this.crossOrigin=`anonymous`,this.side=this.options.side===void 0?0:this.options.side,this.wrap=this.options.wrap===void 0?ie:this.options.wrap}setCrossOrigin(e){return this.crossOrigin=e,this}setManager(e){this.manager=e}setMaterials(e){this.materialsInfo=this.convert(e),this.materials={},this.materialsArray=[],this.nameLookup={}}convert(e){if(!this.options)return e;let t={};for(let n in e){let r=e[n],i={};t[n]=i;for(let e in r){let t=!0,n=r[e],a=e.toLowerCase();switch(a){case`kd`:case`ka`:case`ks`:this.options&&this.options.normalizeRGB&&(n=[n[0]/255,n[1]/255,n[2]/255]),this.options&&this.options.ignoreZeroRGBs&&n[0]===0&&n[1]===0&&n[2]===0&&(t=!1);break;default:break}t&&(i[a]=n)}}return t}preload(){for(let e in this.materialsInfo)this.create(e)}getIndex(e){return this.nameLookup[e]}getAsArray(){let e=0;for(let t in this.materialsInfo)this.materialsArray[e]=this.create(t),this.nameLookup[t]=e,e++;return this.materialsArray}create(e){return this.materials[e]===void 0&&this.createMaterial_(e),this.materials[e]}createMaterial_(e){let t=this,n=this.materialsInfo[e],r={name:e,side:this.side};function i(e,t){return typeof t!=`string`||t===``?``:/^https?:\/\//i.test(t)?t:e+t}function a(e,n){if(r[e])return;let a=t.getTextureParams(n,r),o=t.loadTexture(i(t.baseUrl,a.url));o.repeat.copy(a.scale),o.offset.copy(a.offset),o.wrapS=t.wrap,o.wrapT=t.wrap,(e===`map`||e===`emissiveMap`)&&(o.colorSpace=Ce),r[e]=o}for(let e in n){let t=n[e],i;if(t!==``)switch(e.toLowerCase()){case`kd`:r.color=new K().fromArray(t).convertSRGBToLinear();break;case`ks`:r.specular=new K().fromArray(t).convertSRGBToLinear();break;case`ke`:r.emissive=new K().fromArray(t).convertSRGBToLinear();break;case`map_kd`:a(`map`,t);break;case`map_ks`:a(`specularMap`,t);break;case`map_ke`:a(`emissiveMap`,t);break;case`norm`:a(`normalMap`,t);break;case`map_bump`:case`bump`:a(`bumpMap`,t);break;case`map_d`:a(`alphaMap`,t),r.transparent=!0;break;case`ns`:r.shininess=parseFloat(t);break;case`d`:i=parseFloat(t),i<1&&(r.opacity=i,r.transparent=!0);break;case`tr`:i=parseFloat(t),this.options&&this.options.invertTrProperty&&(i=1-i),i>0&&(r.opacity=1-i,r.transparent=!0);break;default:break}}return this.materials[e]=new fs(r),this.materials[e]}getTextureParams(e,t){let n={scale:new H(1,1),offset:new H(0,0)},r=e.split(/\s+/),i;return i=r.indexOf(`-bm`),i>=0&&(t.bumpScale=parseFloat(r[i+1]),r.splice(i,2)),i=r.indexOf(`-s`),i>=0&&(n.scale.set(parseFloat(r[i+1]),parseFloat(r[i+2])),r.splice(i,4)),i=r.indexOf(`-o`),i>=0&&(n.offset.set(parseFloat(r[i+1]),parseFloat(r[i+2])),r.splice(i,4)),n.url=r.join(` `).trim(),n}loadTexture(e,t,n,r,i){let a=this.manager===void 0?Os:this.manager,o=a.getHandler(e);o===null&&(o=new Ps(a)),o.setCrossOrigin&&o.setCrossOrigin(this.crossOrigin);let s=o.load(e,n,r,i);return t!==void 0&&(s.mapping=t),s}},_c=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),vc=o(((e,t)=>{t.exports=_c()})),yc=vc();function bc(e){let t=[],n=e=>{typeof e?.[0]==`number`?t.push(e):e?.forEach(n)};return n(e.geometry.coordinates),t.length?[t.reduce((e,t)=>e+t[0],0)/t.length,t.reduce((e,t)=>e+t[1],0)/t.length]:[112.9444,28.1908]}var xc=Math.PI,Sc=6378245,Cc=.006693421622965943;function wc(e,t){let n=-100+2*e+3*t+.2*t*t+.1*e*t+.2*Math.sqrt(Math.abs(e));return n+=(20*Math.sin(6*e*xc)+20*Math.sin(2*e*xc))*2/3,n+=(20*Math.sin(t*xc)+40*Math.sin(t/3*xc))*2/3,n+=(160*Math.sin(t/12*xc)+320*Math.sin(t*xc/30))*2/3,n}function Tc(e,t){let n=300+e+2*t+.1*e*e+.1*e*t+.1*Math.sqrt(Math.abs(e));return n+=(20*Math.sin(6*e*xc)+20*Math.sin(2*e*xc))*2/3,n+=(20*Math.sin(e*xc)+40*Math.sin(e/3*xc))*2/3,n+=(150*Math.sin(e/12*xc)+300*Math.sin(e/30*xc))*2/3,n}function Ec(e,t){if(e<72.004||e>137.8347||t<.8293||t>55.8271)return[e,t];let n=wc(e-105,t-35),r=Tc(e-105,t-35),i=t/180*xc,a=Math.sin(i);a=1-Cc*a*a;let o=Math.sqrt(a);return n=n*180/(Sc*(1-Cc)/(a*o)*xc),r=r*180/(Sc/o*Math.cos(i)*xc),[e+r,t+n]}var Dc={teaching:`#d9c6a4`,library:`#b78b67`,sports:`#d97b5d`,dining:`#d5a54e`,residence:`#aab6c3`,service:`#c8c5b8`},Oc=null;function kc(e){return window.AMap?Promise.resolve(window.AMap):Oc||(Oc=new Promise((t,n)=>{let r=document.querySelector(`script[src*="webapi.amap.com/maps"]`);if(r){r.onload=()=>t(window.AMap),r.onerror=e=>n(e);return}let i=document.createElement(`script`);i.type=`text/javascript`,i.src=`https://webapi.amap.com/maps?v=2.0&key=${e}&plugin=AMap.GeoJSON,AMap.Polygon,AMap.Polyline,AMap.ControlBar`,i.onload=()=>{t(window.AMap)},i.onerror=e=>{n(e)},document.head.appendChild(i)}),Oc)}function Ac(e,t,n={}){let r=[],i=window.AMap;return!i||!e||!e.features||e.features.forEach((e,a)=>{let o=e.geometry;if(!o)return;let s=typeof t==`function`?t(e,a):t;if(o.type===`Polygon`){let t=new i.Polygon({path:o.coordinates,extData:e,...s});jc(t,n,e),r.push(t)}else if(o.type===`MultiPolygon`)o.coordinates.forEach(t=>{let a=new i.Polygon({path:t,extData:e,...s});jc(a,n,e),r.push(a)});else if(o.type===`LineString`){let t=new i.Polyline({path:o.coordinates,extData:e,...s});jc(t,n,e),r.push(t)}else o.type===`MultiLineString`&&o.coordinates.forEach(t=>{let a=new i.Polyline({path:t,extData:e,...s});jc(a,n,e),r.push(a)})}),r}function jc(e,t,n){Object.keys(t).forEach(r=>{e.on(r,i=>{t[r](n,e,i)})})}function Mc({datasets:e,buildings:t,selectedBuilding:n,setSelectedBuilding:r,activeRoute:i,focusName:a}){let o=(0,_.useRef)(null),s=(0,_.useRef)(null),[c,l]=(0,_.useState)(!!window.AMap),[u,d]=(0,_.useState)(!0),f=(0,_.useRef)(u),[p,m]=(0,_.useState)(`color`),h=(0,_.useRef)(p),g=(0,_.useRef)([]),v=(0,_.useRef)([]),y=(0,_.useRef)([]),b=(0,_.useRef)([]),x=(0,_.useRef)([]),S=(0,_.useRef)([]),C=(0,_.useRef)(null),w=(0,_.useRef)(null);return(0,_.useEffect)(()=>{f.current=u},[u]),(0,_.useEffect)(()=>{h.current=p},[p]),(0,_.useEffect)(()=>{kc(`07affa979c5e94a38e8cff791df7df96`).then(()=>{l(!0)}).catch(e=>{console.error(`加载高德地图失败:`,e)})},[]),(0,_.useEffect)(()=>{if(!c||!e||!o.current||s.current)return;let t=window.AMap,n=new t.Map(o.current,{zoom:17,center:Ec(112.9444,28.1908),viewMode:`3D`,pitch:f.current?55:0,rotation:f.current?15:0,features:[`bg`],zoomEnable:!0,dragEnable:!0,pitchEnable:!0,rotateEnable:!0,buildingAnimation:!0});s.current=n,n.plugin([`AMap.ControlBar`],()=>{let e=new t.ControlBar({position:{left:`18px`,top:`18px`},showZoomBar:!1,showControlButton:!0});n.addControl(e)});let r=[112.94439936956965,28.19068143590572],i=Ec(r[0],r[1]);n.customCoords.setCenter(i);let a=Ec(112.9391912,28.1853094),l=Ec(112.9496931,28.196472);n.setBounds(new t.Bounds(a,l)),C.current=new t.InfoWindow({isCustom:!0,offset:new t.Pixel(0,-10),autoMove:!1,content:``}),n.on(`pitch`,()=>{let e=n.getPitch();d(e>15)});let u=Ac(e.boundary,{strokeColor:`#204f48`,strokeWeight:2.2,strokeOpacity:.8,fillColor:`#edf0df`,fillOpacity:1,strokeStyle:`dashed`,strokeDasharray:[7,5]});n.add(u),g.current=u;let p=Ac(e.water,{strokeColor:`#92bdc1`,strokeWeight:1,fillColor:`#b9dadd`,fillOpacity:.9});n.add(p),v.current=p;let m=Ac(e.roads,e=>{let t=[`secondary`,`primary`,`tertiary`].includes(e.properties?.highway);return{strokeColor:t?`#d7cfc0`:`#eee8dc`,strokeWeight:t?5:2.2,strokeOpacity:.95,lineCap:`round`,lineJoin:`round`}});n.add(m),y.current=m;let h,_,b,x=new t.GLCustomLayer({zIndex:110,init:e=>{h=new Vo({context:e,antialias:!0}),h.autoClear=!1,_=new Uo,b=new kr(60,window.innerWidth/window.innerHeight,1,1e5);let t=new Hs(16777215,.75);_.add(t);let r=new Vs(16777215,.6);r.position.set(300,800,400),_.add(r);let i=new Rn({color:16777215,transparent:!1,opacity:1}),a=new Wo({color:9741240,linewidth:1});new hc().load(`/models/white_model.mtl`,e=>{e.preload();let t=new mc;t.setMaterials(e),t.load(`/models/white_model.obj`,e=>{e.scale.set(1.1345,1.1345,1.1345),e.rotation.z=-.918*Math.PI/180,e.position.set(-4.5,2,0),e.traverse(e=>{if(e.isMesh){e.material=i,e.castShadow=!1,e.receiveShadow=!1;let t=new $o(new ds(e.geometry,15),a);e.add(t)}}),_.add(e),n.render()})})},render:()=>{if(!h||!_||!b)return;let{near:e,far:t,fov:r,up:i,lookAt:a,position:o}=n.customCoords.getCameraParams();b.near=e,b.far=t,b.fov=r,b.position.set(...o),b.up.set(...i),b.lookAt(...a),b.updateProjectionMatrix(),h.resetState(),h.render(_,b),n.render()}});return n.add(x),w.current=x,f.current?x.show():x.hide(),()=>{s.current&&=(s.current.destroy(),null)}},[c,e]),(0,_.useEffect)(()=>{let e=s.current;if(!e||!c)return;let i=window.AMap;b.current.length>0&&(e.remove(b.current),b.current=[]),x.current.length>0&&(e.remove(x.current),x.current=[]);let a=[],o=Ac({type:`FeatureCollection`,features:t},e=>{let t=n?.properties?.mapId===e.properties?.mapId,r=Dc[e.properties?.category]||`#c8c5b8`,i=e.properties?.name?.includes(`田径场`);return f.current?i?{strokeColor:t?`#1e6258`:h.current===`white`?`#cbd5e1`:`#fffdf6`,strokeWeight:t?2:1.2,fillColor:t?`#1e6258`:h.current===`white`?`#f1f5f9`:`#e28b75`,fillOpacity:.8,height:0}:{strokeColor:t?`#1e6258`:`transparent`,strokeWeight:t?2:1.2,fillColor:t?`#1e6258`:`transparent`,fillOpacity:t?.35:.001,height:15}:h.current===`white`?{strokeColor:`#cbd5e1`,strokeWeight:t?2:1.2,fillColor:t?`#1e6258`:`#ffffff`,fillOpacity:.98,height:0}:{strokeColor:`#fffdf6`,strokeWeight:t?2:1.2,fillColor:t?`#1e6258`:r,fillOpacity:.96,height:0}},{mouseover:(t,n,r)=>{let i=t.properties?.category,a=t.properties?.name?.includes(`田径场`),o=h.current===`white`?`#1e6258`:Dc[i]||`#1e6258`;n.setOptions({fillColor:o,fillOpacity:f.current?a?.9:.4:.95,strokeColor:o,strokeWeight:2});let s=t.properties?.displayName;C.current.setContent(`<div class="campus-tooltip">${s}</div>`),C.current.open(e,r.lnglat)},mousemove:(e,t,n)=>{C.current.setPosition(n.lnglat)},mouseout:(e,t)=>{let r=n?.properties?.mapId===e.properties?.mapId,i=e.properties?.name?.includes(`田径场`);if(f.current)i?t.setOptions({fillColor:r?`#1e6258`:h.current===`white`?`#f1f5f9`:`#e28b75`,fillOpacity:.8,strokeColor:r?`#1e6258`:h.current===`white`?`#cbd5e1`:`#fffdf6`,strokeWeight:r?2:1.2}):t.setOptions({fillColor:r?`#1e6258`:`transparent`,fillOpacity:r?.35:.001,strokeColor:r?`#1e6258`:`transparent`,strokeWeight:r?2:1.2});else{let n,i;h.current===`white`?(n=r?`#1e6258`:`#ffffff`,i=`#cbd5e1`):(n=r?`#1e6258`:Dc[e.properties?.category]||`#c8c5b8`,i=`#fffdf6`),t.setOptions({fillColor:n,strokeColor:i,strokeWeight:r?2:1.2,fillOpacity:.96})}C.current.close()},click:t=>{r(t);let n=bc(t);e.setZoomAndCenter(Math.max(e.getZoom(),18),n)}});e.add(o),b.current=o,t.forEach(t=>{let n=t.properties?.displayName;if(n&&n!==`校园建筑`){let r=bc(t),o=new i.Marker({position:r,content:`<div class="building-label"><span>${n}</span></div>`,offset:new i.Pixel(-60,-10),bubble:!0,zIndex:100});e.add(o),a.push(o)}}),x.current=a},[t,n,c,r,p]),(0,_.useEffect)(()=>{let e=s.current;if(!e||!c)return;let t=window.AMap;if(S.current.length>0&&(e.remove(S.current),S.current=[]),!i)return;let n=[],r=i.coordinates.map(e=>[e[1],e[0]]),a=i.color,o=(e,t)=>{let n=parseInt(e.replace(`#`,``),16),r=Math.max(0,(n>>16)-t),i=Math.max(0,(n>>8&255)-t),a=Math.max(0,(n&255)-t);return`#${(r<<16|i<<8|a).toString(16).padStart(6,`0`)}`},l=new t.Polyline({path:r,strokeColor:a,strokeWeight:14,strokeOpacity:.15,lineCap:`round`,lineJoin:`round`});e.add(l),n.push(l);let u=new t.Polyline({path:r,strokeColor:o(a,60),strokeWeight:7,strokeOpacity:.3,lineCap:`round`,lineJoin:`round`});e.add(u),n.push(u);let d=new t.Polyline({path:r,strokeColor:a,strokeWeight:5,strokeOpacity:.95,lineCap:`round`,lineJoin:`round`});e.add(d),n.push(d);let f=new t.Polyline({path:r,strokeColor:`#ffffff`,strokeWeight:2,strokeOpacity:.5,lineCap:`round`,lineJoin:`round`});e.add(f),n.push(f);let p=Math.max(2,Math.floor(r.length/8));for(let i=0;i<r.length-1;i+=p){let o=r[i],s=r[Math.min(i+1,r.length-1)],c=(o[0]+s[0])/2,l=(o[1]+s[1])/2,u=new t.Marker({position:[c,l],content:`<div style="
        ...
        "></div>`,offset:new t.Pixel(-5,-4),zIndex:160});e.add(u),n.push(u)}i.coordinates.forEach((r,s)=>{let c=[r[1],r[0]],l=s===0,u=s===i.coordinates.length-1,d=l||u?32:26,f=l||u?4:3,p=new t.Marker({position:c,content:`<div class="route-marker" style="
